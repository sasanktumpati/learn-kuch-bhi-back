...
class QuizQuestionRecord(Base):
    ...
    room: Mapped["QuizRoomRecord"] = relationship("QuizRoomRecord", back_populates="questions")
...
class QuizPlayerRecord(Base):
    ...
    room: Mapped["QuizRoomRecord"] = relationship("QuizRoomRecord", back_populates="players")
...
class QuizAnswerRecord(Base):
    ...
    answered_at: Mapped[datetime] = mapped_column(DateTime, server_default=func.now(), index=True)

    player: Mapped["QuizPlayerRecord"] = relationship("QuizPlayerRecord", back_populates="answers")
